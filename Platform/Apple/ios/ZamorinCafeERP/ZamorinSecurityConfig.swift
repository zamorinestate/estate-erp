...
/// ZAMORIN CAFÉ ERP — APPLE iOS/iPadOS SECURITY & ORIGIN GOVERNANCE
/// Enforces HTTPS production origins, Universal Link parsing, and navigation boundaries.
public struct ZamorinSecurityConfig {
    ...
    /// Parses and validates café reference from Apple Universal Link URL (/cafe/<ref>/login)
